                    ...
                    <nav className="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                        <div className="container-fluid">
                            <div className="navbar-wrapper">
                                <a className="navbar-brand" href="javascript:;">Список клієнтів</a>
                            </div>
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="card">
                                        <div className="cardsidebar-header card-header-primary">
                                            <h4 className="card-title ">Договора на обслуговування</h4>
                                            <p className="card-category"> Список об'єктів з договорами на обслуговування</p>
                                        </div>
                    ...
                    <ul className="dropdown-menu">
                        ...
                        <li className="button-container">
                            <a href="https://www.creative-tim.com/product/material-dashboard" target="_blank"
                               className="btn btn-primary btn-block">Free Download</a>
                        </li>
                        ...
                        <li className="button-container github-star">
                            <a className="github-button"
                               href="https://github.com/creativetimofficial/material-dashboard" data-icon="octicon-star"
